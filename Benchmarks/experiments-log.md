...
## ЭКСП-001 (05.08) — Baseline: random search vs systematic
...
## ЭКСП-002 (05.08) — Null-calibration on auto-mpg
200 shuffle permutations: 0 false positives at calibrated threshold.

## ЭКСП-003 (05.08) — Sudoku: honesty and grammar expressiveness boundary
...
## ЭКСП-005 (05.08) — TSP: evolutionary framework
...
## ЭКСП-008 (05.08) — gplearn vs Bee Swarm: PARITY
...
## ЭКСП-009 (05.08) — Noise & scale: first confirmed difference
...
## ЭКСП-012 (05.08) — Sign-changing targets: confirmed CV gap
...
## ЭКСП-013/014 (06.08) — Cultural propagation A/B
...
## ЭКСП-015 (06.08) — GRAMMAR-BIRTH: operators born
...
## ЭКСП-016 (06.08) — Culture coefficient curve: FLAT
...
structures. The earlier ×2.1 (ЭКСП-014) was a confound: warm DB vs cold DB.
Lesson: A/B only with identical DB history.

## ЭКСП-017 (07.08) — Colony economics baseline
...
## ЭКСП-019/020 (07.08) — Beam search economics
...
## ЭКСП-021 (08.08, VDS) — Long horizon 1h+1h
...
## ЭКСП-022 (08.08) — Deficit gradient
...
## ЭКСП-022c (08.08) — Reward deficit does NOT create selection
...
## ЭКСП-022d (08.08) — R=0.5 → drift, NOT monoculture
...
## Summary for the paper (ИИ-рецензент, 07.08)

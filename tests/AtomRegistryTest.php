...
class AtomRegistryTest extends TestCase
{
     ...
     * Все атомы доступны
     */
    public function testAllAtomsAvailable(): void
    {
     ...
     * Унарные атомы есть
     */
    public function testUnaryAtomsPresent(): void
    {
        $atoms = AtomRegistry::all();
     ...
     * Бинарные атомы есть
     */
    public function testBinaryAtomsPresent(): void
    {
        $atoms = AtomRegistry::all();
     ...
     * apply: унарный
     */
    public function testApplyUnary(): void
    {
     ...
     * apply: бинарный
     */
    public function testApplyBinary(): void
    {
     ...
     */
    public function testApplySqrtNegative(): void
    {
     ...
     */
    public function testApplyLogNegative(): void
    {
     ...
     */
    public function testComposeAbsSub(): void
    {
     ...
     */
    public function testComposeMulMin(): void
    {
     ...
     */
    public function testComposeSqAdd(): void
    {
     ...
     */
    public function testSignalAccumulation(): void
    {
        $tasks = [
            [
     ...
     */
    public function testCrossDomainBonus(): void
    {
        $tasks = [
            [
                'X' => [[-3.0], [-1.0], [0.0], [2.0]],

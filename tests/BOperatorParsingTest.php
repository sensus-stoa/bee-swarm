...
class BOperatorParsingTest extends TestCase
{
    public function testBOperatorParsesAndEvaluates(): void
    {
        ...
        $X = [[2.0, 3.0], [5.0, 7.0]];
        $r = ExpressionEvaluator::evaluateFormula('(x0B7a7aee(x1))', $X, null, ['B7a7aee'], [
            'B7a7aee' => '(x0addx1)',
        ]);
    ...
    public function testBOperatorInComposition(): void
    {
        ...
        $r = ExpressionEvaluator::evaluateFormula('((x0B7a7aee(x1))mulx2)', $X, null, ['B7a7aee'], [
            'B7a7aee' => '(x0addx1)',
        ]);
    ...
    public function testUnknownBPrefixStillNull(): void
    {
        ...
        $X = [[1.0, 2.0]];
        $r = ExpressionEvaluator::evaluateFormula('(x0Bdeadbe(x1))', $X, null, ['B7a7aee'], [
            'B7a7aee' => '(x0addx1)',
        ]);

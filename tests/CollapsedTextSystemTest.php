...
class CollapsedTextSystemTest extends TestCase
{
     ...
     */
    public function testClozeGeneratorProducesFalsifiableTasks(): void
    {
     ...
     */
    public function testContextPrimitive(): void
    {
        $sentence = [0, 1, 2];
     ...
     */
    public function testMatchPrimitive(): void
    {
     ...
     */
    public function testComposeDiscoversIsAPattern(): void
    {
        $tasks = $this->generateClozeTasks($this->corpus, $this->vocab);
     ...
     */
    public function testRandomGuessGivesHighError(): void
    {
        $tasks = $this->generateClozeTasks($this->corpus, $this->vocab);

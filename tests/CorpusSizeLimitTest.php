...
class CorpusSizeLimitTest extends TestCase
{
    ...
    public function test_vocabulary_has_upper_limit(): void
    {
        ...
        $this->assertLessThanOrEqual(5000, $vocab->size(), 
            'Словарь не должен превышать 5000 слов');
    }
    
    /** Сканирует не более 200 файлов */
    public function test_scans_limited_files(): void
    {
        $lair = getenv('HOME') . '/Documents/the_lair';
        if (!is_dir($lair)) {
            $this->markTestSkipped('Lair not found');
    ...
    public function test_words_with_digits_are_skipped(): void
    {
    ...
    public function test_short_words_are_skipped(): void
    {

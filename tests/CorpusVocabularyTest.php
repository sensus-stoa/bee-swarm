...
class CorpusVocabularyTest extends TestCase
{
    ...
    public function test_builds_vocabulary_from_files(): void
    {
    ...
    public function test_unknown_word_returns_null(): void
    {
        file_put_contents($this->tmpDir . '/a.md', "Сократ является человеком.\n");
    ...
    public function test_reverse_lookup(): void
    {
        file_put_contents($this->tmpDir . '/a.md', "Сократ является человеком.\n");
    ...
    /** Размер словаря */
    public function test_vocabulary_size(): void
    {
        file_put_contents($this->tmpDir . '/a.md', "Сократ является человеком.\n");
    ...
    public function test_tokenize_sentence(): void
    {
        file_put_contents($this->tmpDir . '/a.md', "Сократ является человеком.\n");

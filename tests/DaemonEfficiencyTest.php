...
class DaemonEfficiencyTest extends TestCase
{
     ...
     */
    public function test_search_find_performance(): void
    {
        $g = new Grammar();
        $ops = $g->all();
     ...
     */
    public function test_search_find_depth3_has_time_bound(): void
    {
        $g = new Grammar();
        $X = [[1,2],[3,4],[5,6]];
        $y = [3,7,11];
     ...
     */
    public function test_minimum_sleep_limits_tick_rate(): void
    {
     ...
     */
    public function test_exponential_backoff_on_failures(): void
    {

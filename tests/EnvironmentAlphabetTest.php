...
class EnvironmentAlphabetTest extends TestCase
{
     ...
     */
    public function testEnvironmentAlphabetHasAtoms(): void
    {
     ...
     * Унарные атомы есть
     */
    public function testUnaryAtomsFromEnv(): void
    {
     ...
     * Бинарные атомы есть
     */
    public function testBinaryAtomsFromEnv(): void
    {
        AtomRegistry::loadEnvironment();
        $all = AtomRegistry::all();
     ...
     */
    public function testFilesystemAtomsFromEnv(): void
    {
        AtomRegistry::loadEnvironment();
        $all = AtomRegistry::all();
     ...
     */
    public function testStringAtomsFromEnv(): void
    {
        AtomRegistry::loadEnvironment();
        $all = AtomRegistry::all();
     ...
     */
    public function testEnvironmentCaching(): void
    {
     ...
     */
    public function testEnvAtomsSolveTasks(): void
    {
        AtomRegistry::loadEnvironment();

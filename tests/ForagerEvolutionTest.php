...
class ForagerEvolutionTest extends TestCase
{
     ...
     */
    public function testDifferentStrategiesForDifferentFormats(): void
    {
        file_put_contents($this->tmpDir . '/data.json', json_encode([[
            'x' => 1,
            'y' => 2,
        ],
            [
     ...
     */
    public function testFailingStrategyRemoved(): void
    {
     ...
     */
    public function testComposeStrategiesWork(): void
    {
        file_put_contents($this->tmpDir . '/data.json', json_encode([[
            'x' => 1,
            'y' => 2,
        ...
        $hasPairs = false;
        foreach ($tasks as $t) {
            if (count($t['data']) >= 3 && count($t['data'][0]) >= 2) {
                $hasPairs = true;
            }
        }
     ...
     */
    public function testPriorityGrowsWithDiscoveries(): void
    {
     ...
     */
    public function testEmptyDirPriorityUnchanged(): void
    {
     ...
     */
    public function testUnreadableFileHandled(): void
    {
     ...
     */
    public function testMalformedJsonSkipped(): void
    {

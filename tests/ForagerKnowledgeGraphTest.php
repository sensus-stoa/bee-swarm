...
class ForagerKnowledgeGraphTest extends TestCase
{
     ...
     */
    public function testForagerInsertsFactsIntoKg(): void
    {
        $db = Database::get();
        $before = (int) $db->query('SELECT COUNT(*) FROM knowledge_graph')
            ->fetchColumn();
        ...
        $after = (int) $db->query('SELECT COUNT(*) FROM knowledge_graph')
            ->fetchColumn();
     ...
     */
    public function testRepeatedFactIncreasesConfidence(): void
    {
        $db = Database::get();
     ...
     */
    public function testSingleOccurrenceGivesLowConfidence(): void
    {
        $db = Database::get();

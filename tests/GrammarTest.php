...
class GrammarTest extends TestCase
{
    ...
    /** Базовые операции: +, ×, −, / */
    public function test_base_ops_present(): void
    {
        $ops = $this->g->all();
    ...
    /** apply: сложение */
    public function test_apply_add(): void
    {
        $this->assertSame(5.0, $this->g->apply(2, 3, '+'));
    }

    /** apply: умножение */
    public function test_apply_mul(): void
    {
        $this->assertSame(6.0, $this->g->apply(2, 3, '×'));
    }

    /** apply: вычитание */
    public function test_apply_sub(): void
    {
        $this->assertSame(-1.0, $this->g->apply(2, 3, '−'));
    }

    /** apply: деление */
    public function test_apply_div(): void
    {
    ...
    public function test_add_new_op(): void
    {
    ...
    public function test_add_with_definition(): void
    {
        $def = json_encode(['op' => '+', 'left' => 'a', 'right' => 'b']);
    ...
    public function test_restrict(): void
    {
        $this->g->restrictTo(['+', '−']);
        $ops = $this->g->all();
        $this->assertContains('+', $ops);

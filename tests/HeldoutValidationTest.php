...
class HeldoutValidationTest extends TestCase
{
     ...
     */
    public function testRandomDataNoFalsePositives(): void
    {
        $X = [];
        $y = [];
        for ($i = 0; $i < 10; $i++) {
     ...
     */
    public function testOverfitMarkerInResult(): void
    {
     ...
     */
    public function testRetrospectiveValidateExists(): void
    {
        $this->assertTrue(
            method_exists(AtomRegistry::class, 'retrospectiveValidate'),
     ...
     */
    public function testHeldoutFiltersMoreThanDiscover(): void
    {
        $X = [];
        $y = [];
        for ($i = 0; $i < 15; $i++) {
     ...
     */
    public function testHeldoutEnabledFlag(): void
    {
        $this->assertTrue(
            AtomRegistry::isHeldoutEnabled(),

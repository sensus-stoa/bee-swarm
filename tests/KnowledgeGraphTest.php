...
class KnowledgeGraphTest extends TestCase
{
     ...
     */
    public function testMetricLawCreatesFact(): void
    {
    ...
    public function testSyntheticLawCreatesIsALawFact(): void
    {
        $db = \BeeSwarm\Infra\Database::get();
    ...
    public function testGraphHasRelatesToFacts(): void
    {
        $db = \BeeSwarm\Infra\Database::get();
        $count = $db->query("SELECT COUNT(*) FROM knowledge_graph WHERE predicate = 'relates_to'")
            ->fetchColumn();
     ...
     */
    public function testContradictionDetectorIgnoresHierarchy(): void
    {
        $db = \BeeSwarm\Infra\Database::get();

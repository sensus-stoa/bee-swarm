...
class LiveExecutorTest extends TestCase
{
    ...
    public function testReconcileKeepsCloseAfter(): void
    {
        ...
        [$newState, $closed] = LiveExecutor::reconcileState($state, [
            'DOTUSDT' => 8.0,
        ], 999);
    ...
    {
        [$newState, $closed] = LiveExecutor::reconcileState([
            'open' => [],
        ], [
            'ADAUSDT' => 5.0,
        ], 1000);

...
class SemanticFalsificationTest extends TestCase
{
     ...
     */
    public function testSemanticTaskHasNegativeExamples(): void
    {
     ...
     */
    public function testParasiteAtomFailsOnFalsifiableTask(): void
    {
     ...
     */
    public function testDiscriminatingAtomPassesCv0(): void
    {
        // Та же задача
        $y = [1.0, 1.0, 0.0];
     ...
     */
    public function testForagerShouldNotProduceAllOnesTasks(): void
    {
        $content = "Сократ является человеком.\n";

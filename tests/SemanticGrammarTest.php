...
class SemanticGrammarTest extends TestCase
{
     ...
     */
    public function testIsAIsGrammarAtom(): void
    {
        $g = new Grammar();
        $ops = $g->all();
     ...
     */
    public function testIsAApplyReturnsConfidence(): void
    {
        $db = Database::get();
     ...
     */
    public function testSyllogismViaCompose(): void
    {
        $db = Database::get();
        $db->exec("INSERT OR IGNORE INTO knowledge_graph (subject, predicate, object, confidence) VALUES ('Сократ', 'is_a', 'человек', 1.0)");
     ...
     */
    public function testSemanticCv0OnKnownFacts(): void
    {
        $db = Database::get();
     ...
     */
    public function testContradictionResolvesByConfidence(): void
    {
        $db = Database::get();

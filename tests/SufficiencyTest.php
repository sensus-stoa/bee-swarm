...
class SufficiencyTest extends TestCase
{
     ...
     */
    public function testInsufficientDataBlocksDiscovery(): void
    {
     ...
     */
    public function testSufficientDataAllowsDiscovery(): void
    {
        // 10 точек = t_min
        $X = [];
        $y = [];
     ...
     */
    public function testHeldoutRespectsSufficiency(): void
    {
